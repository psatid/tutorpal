...
const buttonVariants = cva(
  ...
  [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 cursor-pointer data-[loading]:cursor-wait disabled:cursor-not-allowed`,
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border-input bg-card hover:bg-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground data-active:border-primary data-active:bg-primary/10 data-active:text-primary data-active:[&_svg]:text-primary",
        secondary:
