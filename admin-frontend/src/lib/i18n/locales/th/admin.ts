...
const th = {
	login: {
		...
		impersonationRecovery:
			"มุมมองผู้สอนอาจสิ้นสุดแล้ว โปรดเข้าสู่ระบบอีกครั้งเพื่อกลับไปยังพอร์ทัลผู้ดูแลระบบ",
		footer:
	...
	users: {
		...
		actions: {
			...
			openTutorView: "เปิดมุมมองผู้สอน",
		...
		impersonation: {
			title: "เปิดมุมมองผู้สอนหรือไม่",
			description:
				"คุณจะมีสิทธิ์เข้าถึง TutorPal ได้เต็มรูปแบบเช่นเดียวกับที่ {{name}} ใช้งานตามปกติ การดำเนินการใด ๆ ที่คุณทำจะส่งผลต่อบัญชี TutorPal ของผู้สอนรายนี้",
			sameTabWarning:
				"ดำเนินการต่อในแท็บนี้เท่านั้น ห้ามใช้แท็บอื่น หน้าต่างส่วนตัว หรือโปรไฟล์เบราว์เซอร์อื่นในระหว่างที่มุมมองผู้สอนยังทำงานอยู่",
			confirm: "เปิดมุมมองผู้สอน",
			opening: "กำลังเปิดมุมมองผู้สอน…",
			openingStatus: "กำลังเปิดมุมมองผู้สอน โปรดรอสักครู่",
			error: "ไม่สามารถเปิดมุมมองผู้สอนได้ โปรดลองอีกครั้ง",
			retry: "ลองอีกครั้ง",
		},
		feedback: {
