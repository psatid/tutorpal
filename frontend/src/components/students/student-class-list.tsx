        ...
        {classes.map((classItem, index) => (
          ...
          >
            ...
            <Badge
              ...
              className={cn(
                "shrink-0 gap-1",
                classItem.remainingHours !== undefined && classItem.remainingHours > 0
            ...
            >
              ...
              {classItem.remainingHours !== undefined
                ? t("classes:hoursWithRemaining", {
                    total: classItem.totalHours,
                    remaining: classItem.remainingHours.toFixed(1),
                  })
                : t("classes:hours", { hours: classItem.totalHours })}
            </Badge>
          </motion.button>
        ))}
      </div>
